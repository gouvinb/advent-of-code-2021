...
To do this, count the __number of times a depth measurement increases__ from the previous measurement. (There is no measurement before the first measurement.
)
